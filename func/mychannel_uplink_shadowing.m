...
%%
function [channel_unit_norm,channel_norms_values,path_loss_dB,channel_nonnormalized] = mychannel_uplink_shadowing(M_ant,K_user,f0_gig,R_max,R_min,...
...
for l_user = 1:n_user
    ...
    log_normal_distribution = sigma_shadowing * randn(1);
    path_loss_dB(l_user) = 20*log10((4*pi)/(cwave)) + 20*log10(d_3D) + 20*log10(f0_gig)+log_normal_distribution; 
